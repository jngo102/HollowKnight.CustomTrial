...
namespace CustomTrial.Behaviours
{
    class AbsoluteRadiance : MonoBehaviour
    {
        ...
        private IEnumerator Start()
        {
            ...
            _control.GetState("Climb Plats1").InsertMethod(0, () =>
            {
            ...
            _commands.GetAction<SpawnObjectFromGlobalPool>("Comb Top").gameObject.Value.PrintSceneHierarchyTree();
            _commands.GetAction<SpawnObjectFromGlobalPool>("Comb L").gameObject.Value.PrintSceneHierarchyTree();
            _commands.GetAction<SpawnObjectFromGlobalPool>("Comb R").gameObject.Value.PrintSceneHierarchyTree();
        }
    }
}
